...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',	dest='dataset',         default='DB8k-28',            help='Dataset to use, default: FB15k-237')
    ...
    parser.add_argument('--model_dir',      type=str,   default='./db8k_model_save', help='The address for storing the models and optimization results.')

    parser.add_argument('--task_name',      type=str,   default='LP', help='The name of the stored models and optimization results.')

    parser.add_argument('--logdir',         dest='log_dir',     default='./db8k_log/',   help='Log directory')
