...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',	dest='dataset',         default='BioKG72k_14',            help='Dataset to use, default: FB15k-237')
    ...
    parser.add_argument('--model_dir',      type=str,   default='./biokg_model_save', help='The address for storing the models and optimization results.')

    parser.add_argument('--task_name',      type=str,   default='LP', help='The name of the stored models and optimization results.')

    parser.add_argument('--logdir',         dest='log_dir',     default='./biokg_log/',   help='Log directory')
