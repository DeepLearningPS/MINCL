...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset',	dest='dataset',         default='DRKG18k-21',                 help='Dataset to use, default: FB15k-237')
    ...
    parser.add_argument('--batch_size', dest='batch_size',      default=2048,    type=int,       help='Batch size for GAT')
    ...
    parser.add_argument('--model_dir',      type=str,   default='./drkg18k-21_model_save', help='The address for storing the models and optimization results.')

    parser.add_argument('--task_name',      type=str,   default='LP', help='The name of the stored models and optimization results.')

    parser.add_argument('--logdir',         dest='log_dir',     default='./drkg18k-21_log/',   help='Log directory')
