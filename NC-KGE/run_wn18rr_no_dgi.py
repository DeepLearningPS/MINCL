...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name',  default='wn18rr',       type=str,                       help='The data name of preprocessed graph.')
    ...
    parser.add_argument('--model_dir',      type=str,   default='./wn18rr_model_save', help='The address for storing the models and optimization results.')

    parser.add_argument('--task_name',      type=str,   default='LP', help='The name of the stored models and optimization results.')

    parser.add_argument('--logdir',         dest='log_dir',     default='./wn18rr_log/',   help='Log directory')
